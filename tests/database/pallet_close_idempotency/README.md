...
misma marca UTC futura. Usan barreras de auditoría sintéticas, con autor válido,
para verificar solo después de que ambos clientes terminen. Ninguna prueba
contacta NAV, RFID o impresoras.
