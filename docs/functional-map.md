...
| Salida de palet hacia NAV | `modules/nav-pallet-output.md` | `Application/NavisionOutput`, `Infrastructure/NavisionOutput`, `Integrations/NavisionOutput`, `Worker/NavisionPalletOutputWorker` | Estado dentro de `features/production-flow` | `Application.Tests/NavisionOutput`, `Integrations.Tests/NavisionOutput`, `database/nav_pallet_output_queue` |
