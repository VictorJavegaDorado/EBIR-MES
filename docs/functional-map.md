...
| Panel de fabricacion | `modules/production-dashboard.md` | `Application/ProductionDashboard`, `Infrastructure/ProductionDashboard`, `Api/Endpoints/ProductionDashboard` | `features/production-dashboard` | `IntegrationTests/ProductionDashboard`, `component/features/production-dashboard` |
...
| Salida de palet hacia NAV | `modules/nav-pallet-output.md` | `Application/NavisionOutput`, `Infrastructure/NavisionOutput`, `Integrations/NavisionOutput`, `Worker/NavisionPalletOutputWorker`; NAV: 50013, 50036, 50056, 60103 y 82000 mediante `deploy/nav/NAV-001A`; administracion Job Queue mediante `deploy/nav/NAV-001B`, recurrencia controlada mediante `deploy/nav/NAV-001C` y disparo inmediato aislado mediante `deploy/nav/NAV-001D` | Estado dentro de `features/production-flow` | `Application.Tests/NavisionOutput`, `Integrations.Tests/NavisionOutput`, `database/nav_pallet_output_queue`, `nav/autonomous_mes_output`, `nav/job_queue_mes_admin`, `nav/job_queue_mes_recurring`, `nav/job_queue_mes_immediate` |
...
| Control y reimpresion supervisada de etiquetas de palet | `modules/palletization.md` | `Application/Printing/LabelControl`, `Application/Printing/ReprintPalletLabel`, `Infrastructure/Printing`, `Api/Endpoints/Printing`; SQL: `database/038A_reimpresion_etiqueta_palet.sql` | `features/label-control`, ruta `/etiquetas`; `features/label-reprint` | `Application.Tests/Printing`, `IntegrationTests/Printing`, `component/features/label-control`, `component/features/label-reprint`, `database/label_reprint` |
